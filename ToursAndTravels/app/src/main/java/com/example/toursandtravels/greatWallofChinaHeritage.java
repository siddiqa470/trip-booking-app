...
public class greatWallofChinaHeritage extends AppCompatActivity {
    ImageButton back_btn;
    Button book_place;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_great_wallof_china_heritage);
        ...
        book_place.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("PLACE_NAME", "Great Wall of China");
                startActivity(intent);
            }
        });
    }
