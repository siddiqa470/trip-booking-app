...
public class hogiSophiaHeritage extends AppCompatActivity {
    ImageButton back_btn;
    Button book_place;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hogi1_sophia_heritage);
        ...
        book_place.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("PLACE_NAME", "Hagia Sophia");
                startActivity(intent);
            }
        });
    }
