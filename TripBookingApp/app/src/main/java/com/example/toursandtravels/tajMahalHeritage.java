...
public class tajMahalHeritage extends AppCompatActivity {
    ImageButton back_btn;
    Button book_place;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_taj_mahal_heritage);
        ...
        book_place.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("PLACE_NAME", "Taj Mahal"); // Pass the place name
                startActivity(intent);
            }
        });
    }
